...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('products')->insert([[
            ...
            'type' => 'juego',
            'image_route' => 'images/banner-liga-de-cohetes.png',
            'image_description' => 'Banner de la Liga de Cohetes',
            ...
            'type' => 'complemento',
            'image_route' => 'images/cosmetics.jpg',
            'image_description' => 'Banner de plus de cohetes',
